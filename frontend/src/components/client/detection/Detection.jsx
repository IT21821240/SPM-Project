...
import bg from "../../../assets/detection.jpeg";
...
const Detection = () => {
  ...
  const treatmentSuggestions = {
    "Pepper,_bell___Bacterial_spot":
      "Remove infected leaves, practice crop rotation, use resistant varieties, sanitize tools, Water plants at the base rather than overhead and apply copper-based fungicides.",
    "Powdery Mildew": "Use fungicides and ensure proper air circulation.",
    "Grape___Esca_(Black_Measles)":
      "Remove infected vines, improve air circulation, apply fungicides, Maintain proper vine health through adequate watering, nutrient management, pruning and monitor for symptoms.",
    Tomato___Early_blight:
      "Remove affected leaves, improve air circulation, and apply fungicides.",
  };
  ...
  const handleSubmit = async (event) => {
    try {
      ...
      if (response) {
        ...
        const treatment =
          treatmentSuggestions[response.predicted_class] ||
      ...
      >
        ...
        <div className="bg-white p-10 rounded-lg shadow-lg w-full max-w-3xl border border-gray-300">
          ...
          <p className="text-gray-700 mb-8 text-lg">
            ...
            affecting your plants, Our advanced system leverages cutting-edge
            image analysis technology to thoroughly examine the uploaded leaf.
            Once the analysis is complete, youll receive a detailed description
            that not only identifies any diseases present but also provides
            tailored recommendations for treatment and care. By using our
            service, you are taking an important step towards ensuring the
            health and vitality of your plants. Let us help you protect your
            greenery with accurate insights and expert advice.
          </p>
